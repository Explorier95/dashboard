...
return(
    ...
    <section className="flex flex-col gap-10 mb-10" ref={containerRef}>
        ...
        <motion.p style={{ translateX: paragraphOneValue }} className="text-slate-100 font-thin text-2xl w-1/2 mx-auto">Ziel des Praxisprojekts ist die Entwicklung eines interaktiven, übersichtlichen Dashboards für Lehrkräfte, dass die Ergebnisse und Leistungsprofile von Schüler*innen,
        ...
        <motion.p style={{ translateX: paragraphTwoValue }} className="text-slate-100 font-thin text-2xl w-1/2 mx-auto">
